...
class NeuralNetwork:
    def __init__(self):
        self.dense1 = Layer_Dense(2, 64, weight_regularizer_l2=5e-4, bias_regularizer_l2=5e-4)
        self.activation1 = Activation_ReLU()
        self.dropout1 = Layer_Dropout(0.1)
    ...
    def train(self, X, y, epochs=10001, print_every=100):
        for epoch in range(epochs):
            self.forward(X, y)
            self.calculate_metrics(y)
    ...
    def evaluate(self, X, y):
        self.forward(X, y)
        self.calculate_metrics(y)
        print(f'\nTest Set - acc: {self.accuracy:.3f}, loss: {self.loss:.3f}')
